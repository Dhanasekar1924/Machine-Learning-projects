# -*- coding: utf-8 -*-
"""
Created on Sat Jul 17 13:03:32 2021
...
if read==1:
    filepath = "data/SVM/bank-additional-full.csv"
    y_name = 'y'
    dtype_file = "project7_dtype_analysis.txt"
...
#    remove_features=[23, 3, 26, 21, 18]; #label
    ...
    best_param_model = cl.SVC(random_state=100)
    trained_model = pl.clf_train_test(best_param_model,x,y,111,"SVC",pred_th=None)
